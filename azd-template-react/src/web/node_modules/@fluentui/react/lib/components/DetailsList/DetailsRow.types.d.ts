...
import { DetailsRowBase } from '@fluentui/react/lib/components/DetailsList/DetailsRow.base';
import { CheckboxVisibility } from '@fluentui/react/lib/components/DetailsList/DetailsList.types';
import { SelectionMode } from '@fluentui/react/lib/Selection';
import { CollapseAllVisibility } from '@fluentui/react/lib/components/GroupedList/GroupedList.types';
import type { IStyle, ITheme } from '@fluentui/react/lib/Styling';
import type { IColumn, IDetailsListProps } from '@fluentui/react/lib/components/DetailsList/DetailsList.types';
import type { ISelection } from '@fluentui/react/lib/Selection';
import type { IDragDropHelper, IDragDropEvents } from '@fluentui/react/lib/DragDrop';
import type { IViewport } from '@fluentui/react/lib/utilities/decorators/withViewport';
import type { IGroup } from '@fluentui/react/lib/components/GroupedList/GroupedList.types';
import type { IBaseProps, IRefObject, IStyleFunctionOrObject, IRenderFunction, IComponentAs } from '@fluentui/react/lib/Utilities';
import type { IDetailsRowCheckProps, IDetailsCheckboxProps } from '@fluentui/react/lib/components/DetailsList/DetailsRowCheck.types';
import type { IDetailsRowFieldsProps } from '@fluentui/react/lib/components/DetailsList/DetailsRowFields.types';
import type { IFocusZoneProps } from '@fluentui/react/lib/FocusZone';
/**
